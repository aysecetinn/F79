  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const NotificationPage(
          title: 'Duygu Haritası', userId: '', userName: ''),
    );
  }
}
  ...
  FilterChip CreateFilterChip(String emotion, String colorCode) {
    return FilterChip(
      ...
      onSelected: (bool selected) {
        setState(() {
          if (_emotions.length < 3 &&
              !_emotions.contains(emotion + "," + colorCode)) {
            ...
            Card(
              child: Column(
                children: <Widget>[
                  ...
                  Wrap(spacing: 9.0, runSpacing: 2.0, children: <Widget>[
              ...
              child: Column(
                children: <Widget>[
                  ...
                  Wrap(spacing: 5.0, runSpacing: 3.0, children: <Widget>[
                    ...
                    CreateFilterChipForLocation(
                        'Yeme İçme Mekanı', '0Xffd9c8dd'),
            ...
            FutureBuilder<Map<String, dynamic>?>(
                ...
                builder: (BuildContext context,
                  ...
                  if (snapshot.hasData) {
                    ...
                    return Text("Kayıt Butonu Yükleniyor");
                  }
                }),
          ],
        )),
